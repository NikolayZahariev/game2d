...
public class Berserker {
    ...
    public Character character = new Character(5, 5, false, false, 0, false, 200, 5, new ArrayList<>(), new int[]{2, 8, 1, 2, 4, 2, 5});
    ...
    public Berserker(TileMap tileMap) {
        ...
        spriteSheet = new SpriteSheet("/sprites/player/playersprites.gif", 7);
